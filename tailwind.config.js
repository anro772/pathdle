...
export default {
  ...
  theme: {
    extend: {
      ...
      keyframes: {
        'pulse-gold': {
          '0%, 100%': { boxShadow: '0 0 5px rgba(200, 155, 60, 0.5)' },
          '50%': { boxShadow: '0 0 20px rgba(200, 155, 60, 0.8), 0 0 30px rgba(200, 155, 60, 0.6)' },
        },
        'bounce-select': {
          '0%': { transform: 'scale(1)' },
        ...
        'glow': {
          '0%': { boxShadow: '0 0 5px rgba(11, 198, 227, 0.5)' },
          '100%': { boxShadow: '0 0 20px rgba(11, 198, 227, 0.8), 0 0 30px rgba(11, 198, 227, 0.6)' },
        },
      },
    },
  },
